...
public class PlayerMove : MonoBehaviour
{
    ...
    public Vector2 DefaultPosition = new Vector2(0.0f, 0.0f);
    public float StopDistance = 0.01f;   // 목적지에 가까워 졌을 때 멈추는 거리
    ...
    private void Update()
    {
        ...
        {
            direction = new Vector2(DefaultPosition.x - position.x, DefaultPosition.y - position.y);

            // StopDistance 이내에 들어가면 도착지점으로 설정하고 움직이지 않게 설정한다.
